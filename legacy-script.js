...
const projectDetailData = {
  "ai-chatbot-flow-design": {
    ...
    links: [
      {
        label: { en: "View Experience", tr: "Deneyimi Gör" },
        url: "blog.html",
      },
    ],
    overview: {
...
const githubRepositoryProjectDetails = {
  ...
  "hospital-appointment-system": {
    ...
    gallery: ["assets/hastane.jpg", "assets/hospital.avif"],
    stack: ["Python", "Tkinter", "MySQL", "MySQL Connector", "PIL", "Datetime"],
    links: [
      {
        label: {
          en: "Open GitHub",
  ...
  "my-java-projects": {
    ...
    gallery: ["assets/java.png"],
    stack: ["Java", "OOP", "Algorithms", "Console Apps"],
    links: [
      {
        label: {
          en: "Open GitHub",
  ...
  "pyhton-projects": {
    ...
    gallery: ["assets/Python-Symbol.png"],
    stack: ["Python", "Automation", "Data Logic", "Scripts"],
    links: [
      {
        label: {
          en: "Open GitHub",
...
const aiWorkflowDemoData = {
  bank: {
    ...
    description: {
      en: "A safe flow for account-related questions, intent routing and escalation.",
      tr: "Hesapla ilgili sorular, intent yönlendirme ve canlı desteğe aktarma için güvenli akış.",
    },
    steps: {
      en: [
        "Greet user",
        ...
        "Route to answer or agent",
        "Confirm resolution",
      ],
      tr: [
        "Kullanıcıyı karşıla",
        "Intent'i algıla",
        "Güvenli talebi doğrula",
        "Gerekli bilgiyi topla",
        "Yanıt veya temsilciye yönlendir",
        "Çözümü onayla",
      ],
    },
  },
  municipality: {
    title: {
      en: "Municipality service assistant",
      tr: "Belediye hizmet asistanı",
    },
    description: {
      en: "A flow for citizens to find service information, create requests and track status.",
      tr: "Vatandaşların hizmet bilgisi bulması, talep oluşturması ve durum takip etmesi için akış.",
    },
    steps: {
      en: [
        "Ask service category",
        "Clarify district/topic",
        "Show required documents",
        "Create request",
        "Share tracking channel",
        "Close with next step",
      ],
      tr: [
        "Hizmet kategorisini sor",
        "İlçe/konuyu netleştir",
        "Gerekli belgeleri göster",
        "Talep oluştur",
        "Takip kanalını paylaş",
        "Sonraki adımla kapat",
      ],
    },
  },
  workshop: {
    title: {
      en: "Workshop reservation assistant",
      tr: "Atölye rezervasyon asistanı",
    },
    description: {
      en: "A customer journey for package choice, date preference and reservation follow-up.",
      tr: "Paket seçimi, tarih tercihi ve rezervasyon takibi için müşteri yolculuğu.",
    },
    steps: {
      en: [
        "Show packages",
      ...
      tr: [
        ...
        "Tarih/saat sor",
        "Rezervasyon özetini gönder",
        "Operasyon takibini tetikle",
      ],
    },
  },
  ecommerce: {
    ...
    description: {
      en: "A flow for product discovery, order questions and return support.",
      tr: "Ürün keşfi, sipariş soruları ve iade desteği için akış.",
    },
    steps: {
      en: [
        "Understand product need",
        "Recommend category",
        "Answer stock/delivery",
        "Check order status",
        "Handle return intent",
        "Offer human support",
      ],
      tr: [
        "Ürün ihtiyacını anla",
        "Kategori öner",
        "Stok/teslimat yanıtla",
        "Sipariş durumunu kontrol et",
        "İade intent'ini yönet",
        "İnsan desteği sun",
      ],
    },
  },
...
function renderAiWorkflowDemo(language = currentSiteLanguage || "en") {
  ...
  if (!stage) return;
  const scenario =
    aiWorkflowDemoData[selectedAiWorkflowScenario] || aiWorkflowDemoData.bank;
