  ...
  window.KAAN_PORTFOLIO = Object.freeze({
    ...
    "profile": {
      ...
      "primaryTitle": {
        ...
        "tr": "Forward Deployed Engineer"
      },
      "backgroundTitle": {
        "en": "AI Designer & Software Developer",
        "tr": "AI Designer & Software Developer"
      },
      "location": {
        "en": "Istanbul / Remote",
        "tr": "İstanbul / Remote"
    ...
    "projects": {
      "sinama": {
        ...
        "proof": [
          {
            "en": "14-scenario typed cross-vertical suite",
            "tr": "14 senaryolu typed cross-vertical suite"
          },
          {
            "en": "Insurance + e-commerce reliability packs",
            "tr": "Insurance + e-commerce reliability pack'leri"
          },
          {
            "en": "Deterministic tool and workflow contracts",
            "tr": "Deterministik tool ve workflow contract'ları"
          },
          {
            "en": "Baseline/regression comparison and version trends",
            "tr": "Baseline/regression karşılaştırması ve version trendleri"
          },
          {
            "en": "READY / WARNING / BLOCKED release-readiness policy",
            "tr": "READY / WARNING / BLOCKED release-readiness politikası"
          },
          {
            "en": "Compatible external HTTPS agent testing",
            "tr": "Uyumlu external HTTPS agent testing"
          }
        ],
        "links": {
        ...
        "currentFocus": {
          "en": "Semantic-judge calibration and stabilization",
      ...
      "mergeRush": {
        ...
        "proof": [
          {
            "en": "4-minute Factory Run target",
          ...
          },
          {
            ...
            "tr": "Aşamalı açılan 25 board hücresi"
          },
          {
            "en": "Factory Run + Endless modes",
    ...
    "projectDetails": {
      "ai-chatbot-flow-design": {
        ...
        "title": {
          "en": "AI Chatbot Flow Design",
          "tr": "AI Chatbot Akış Tasarımı"
        },
        "subtitle": {
          "en": "Enterprise conversational AI experience across QA, stabilization, channel configuration, flow restructuring and multi-channel automation.",
          "tr": "QA, stabilizasyon, kanal yapılandırması, akış yeniden yapılandırma ve çok kanallı otomasyonu kapsayan kurumsal conversational AI deneyimi."
        },
        "role": {
          "en": "AI Designer",
          "tr": "AI Designer"
      ...
      "atolye-joyday-official-website": {
        ...
        "title": {
          "en": "Atölye Joyday Official Website",
          "tr": "Atölye Joyday Resmi Web Sitesi"
        },
        "subtitle": {
        ...
        "year": "2026",
        "type": {
          "en": "Live Business Website",
          "tr": "Canlı İşletme Web Sitesi"
        },
        "status": {
          "en": "Live",
          "tr": "Canlı"
        ...
        "gallery": [
          ...
          "assets/joyday-reservation-preview.webp",
          "assets/joyday-brand-logo.webp"
        ],
        "stack": [
          "HTML",
          "CSS",
        ...
        "features": {
          "en": [
            "Live real-business website",
            "Responsive service pages",
            "Action Painting package presentation",
            "Reservation-oriented customer journey",
            "Clear brand and visual hierarchy"
          ],
          "tr": [
            "Canlı gerçek işletme web sitesi",
            "Responsive hizmet sayfaları",
            "Action Painting paket sunumu",
            "Rezervasyon odaklı müşteri yolculuğu",
            "Net marka ve görsel hiyerarşi"
          ]
        }
      },
      "drivenfinity": {
        ...
        "links": [
          {
            ...
            "url": "https://github.com/UAJOP/Drivenfinity"
          }
        ],
        "overview": {
        ...
        "links": [
          {
            ...
            "url": "https://github.com/UAJOP/DunkerMadness"
          }
        ],
        "overview": {
      ...
      "unity-essentials": {
        ...
        "gallery": [
          "assets/unity-essentials-cover.webp"
        ],
        "stack": [
          "Unity 6",
          "C#",
        ...
        "links": [
          {
            ...
            "url": "https://github.com/UAJOP/UnityEssentials"
          }
        ],
        "overview": {
      ...
      "extract-shoot-zero": {
        ...
        "role": {
          ...
          "tr": "Unreal Engine Developer"
        },
        "year": "2024",
        "type": {
          "en": "Shooter Prototype",
        ...
        "links": [
          {
            ...
            "url": "https://github.com/UAJOP/ExtractShoot-Zero"
          }
        ],
        "overview": {
      ...
      "tank-savage": {
        ...
        "links": [
          {
            ...
            "url": "https://github.com/UAJOP/TankSavage"
          }
        ],
        "overview": {
        ...
        "challenge": {
          ...
          "tr": "Araç tabanlı savaş; karakter tabanlı oyunlara göre farklı kontrol hissi, çarpışma davranışı ve savaş temposu gerektirir."
        },
        "solution": {
          "en": "I approached the project as a prototype for tank control, environment interaction and combat rules using Unreal workflows.",
          "tr": "Projeye Unreal iş akışlarıyla tank kontrolü, çevre etkileşimi ve savaş kuralları prototipi olarak yaklaştım."
        },
        "features": {
          "en": [
            "Tank control logic",
      ...
      "hospital-form-app": {
        "category": {
          "en": "Software / Database",
          "tr": "Yazılım / Veritabanı"
        },
        "title": {
          "en": "Hospital Form App",
          "tr": "Hospital Form App"
        },
        "subtitle": {
      ...
      "cars-dataset-analysis": {
        ...
        "title": {
          "en": "Cars Dataset Analysis",
          "tr": "Cars Veri Seti Analizi"
        },
        "subtitle": {
      ...
      "my-museum": {
        ...
        "links": [
          {
            ...
            "url": "https://github.com/UAJOP/MyMuseum"
          }
        ],
        "overview": {
        ...
        "challenge": {
          ...
          "tr": "Proje, mobil UI ekranlarını Firebase destekli içerik mantığıyla bağlamayı gerektirdi."
        },
        "solution": {
          "en": "I built the app using Kotlin in Android Studio, focusing on core mobile flow and Firebase integration.",
          "tr": "Uygulamayı Android Studio'da Kotlin ile geliştirerek temel mobil akışa ve Firebase entegrasyonuna odaklandım."
        },
        "features": {
          "en": [
            "Kotlin Android app",
      ...
      "control-panel": {
        ...
        "gallery": [
          "assets/control_panel_cover.webp"
        ],
        "stack": [
          "PHP",
          "MySQL",
          ...
          "en": [
            {
              ...
              "text": "Designed a simple Tkinter-based desktop interface that patients and staff can understand quickly."
            },
            {
              "title": "Database setup",
              "text": "Structured MySQL tables and connection logic for users, doctors, appointments and persistent records."
            },
            {
              "title": "Appointment logic",
              "text": "Built scheduling flows around available slots, selected appointment times and user actions."
            },
            {
              "title": "Testing and improvement",
              "text": "Refined the project by testing GUI behavior, database connection and appointment operations."
            }
          ],
          "tr": [
            {
              "title": "Arayüz planlama",
              "text": "Hasta ve personelin hızlı anlayabileceği sade Tkinter tabanlı masaüstü arayüz planlandı."
            },
            {
              "title": "Veritabanı kurulumu",
              "text": "Kullanıcılar, doktorlar, randevular ve kalıcı kayıtlar için MySQL tablo ve bağlantı mantığı yapılandırıldı."
            },
            {
              "title": "Randevu mantığı",
              "text": "Uygun slotlar, seçilen randevu saatleri ve kullanıcı aksiyonları etrafında zamanlama akışları geliştirildi."
            },
            {
              "title": "Test ve geliştirme",
              "text": "GUI davranışı, veritabanı bağlantısı ve randevu işlemleri test edilerek proje iyileştirildi."
            }
          ]
        },
        "features": {
    ...
    "buildLog": [
      {
        ...
        "area": "Portfolio",
        "title": {
          "en": "Shared shell and JSON data foundation V1",
          "tr": "Shared shell ve JSON veri temeli V1"
        },
        "detail": {
          "en": "Moved portfolio truth to a canonical JSON data layer, generated the legacy registry from the same source and established the reusable React shell and V3 design-system foundation without migrating public pages.",
          "tr": "Portfolyo verisi canonical JSON veri katmanına taşındı, legacy registry aynı kaynaktan üretilir hale getirildi ve herkese açık sayfalar henüz taşınmadan reusable React shell ile V3 tasarım sistemi temeli kuruldu."
        },
        "status": "shipped"
      },
      {
        ...
        "area": "Portfolio",
        "title": {
          "en": "React migration foundation V1",
          "tr": "React migrasyon temeli V1"
        },
        "detail": {
          "en": "Established a React, Vite and React Router foundation beside the existing site, proved build-time pre-rendering and left every public page unchanged.",
          "tr": "Mevcut sitenin yanına React, Vite ve React Router temeli kuruldu, derleme zamanı ön-render kanıtlandı ve herkese açık tüm sayfalar değiştirilmeden bırakıldı."
        },
        "status": "shipped"
      },
      {
        ...
        "area": "Portfolio",
        "title": {
          "en": "Asset and LCP optimization V1",
          "tr": "Asset ve LCP optimizasyonu V1"
        },
        "detail": {
          "en": "Reduced critical image transfer, added intrinsic dimensions and established blocking asset regression coverage without changing the visual system.",
          "tr": "Görsel sistemi değiştirmeden kritik görsel transferi azaltıldı, intrinsic boyutlar eklendi ve blocking asset regression kapsamı oluşturuldu."
        },
        "status": "shipped"
      },
      {
        ...
        "area": "Portfolio",
        "title": {
          "en": "Consistency, footer and QA hardening",
          "tr": "Consistency, footer ve QA hardening"
        },
        "detail": {
          "en": "Standardized the canonical site footer, refreshed portfolio truth and hardened the reproducible QA pipeline.",
          "tr": "Canonical site footer standartlaştırıldı, portfolyo verisi tazelendi ve tekrarlanabilir QA pipeline güçlendirildi."
        },
        "status": "shipped"
      },
      {
        ...
        "area": "Portfolio",
        "title": {
          "en": "Semantic card and accessibility cleanup",
          "tr": "Semantic card ve erişilebilirlik temizliği"
        },
        "detail": {
          "en": "Replaced simulated project-card links with native semantics and fixed accessible names that were being dropped.",
          "tr": "Simüle edilmiş project-card link'leri native semantics ile değiştirildi ve düşen accessible name'ler düzeltildi."
        },
        "status": "shipped"
      },
      {
        ...
        "area": "Portfolio",
        "title": {
          "en": "Architecture V2 production audit",
          "tr": "Architecture V2 production audit"
        },
        "detail": {
          "en": "Audited the V2 bootloader, both boot paths and the V2 runtime surfaces, then fixed the regressions found and added guards.",
          "tr": "V2 bootloader'ı, her iki boot path'i ve V2 runtime yüzeyleri denetlendi; bulunan regression'lar düzeltildi ve guard'lar eklendi."
        },
        "status": "shipped"
      },
      {
        ...
        "area": "Portfolio",
        "title": {
          "en": "Portfolio Architecture V2",
          "tr": "Portfolio Architecture V2"
        },
        "detail": {
          "en": "Centralized project truth, recruiter profiles, evidence and build status into one registry behind a compatibility bootloader.",
          "tr": "Project truth, recruiter profilleri, evidence ve build status, uyumluluk bootloader'ı arkasında tek registry'de merkezileştirildi."
        },
        "status": "shipped"
      },
      {
        ...
        "area": "SINAMA",
        "title": {
          "en": "Semantic Judge shadow integration",
          "tr": "Semantic Judge shadow entegrasyonu"
        },
        "detail": {
          "en": "Added an advisory semantic layer without letting it override deterministic reliability verdicts.",
          "tr": "Deterministik reliability kararlarını değiştirmeyen advisory semantic katman eklendi."
        },
        "status": "integration"
      },
      {
        ...
        "area": "Merge Rush",
        "title": {
          "en": "Gameplay pacing and retention pass",
          "tr": "Gameplay pacing ve retention pass"
        },
        "detail": {
          "en": "Deepened progression, board pressure and production architecture for the current game direction.",
          "tr": "Güncel oyun yönünde progression, board pressure ve production architecture derinleştirildi."
        },
        "status": "building"
      }
    ],
    "labs": [
      {
        ...
        "type": {
          "en": "Workflow logic experiment",
          "tr": "Workflow logic deneyi"
        },
        "description": {
      ...
      },
      {
        ...
        "type": {
          "en": "Canvas / math experiment",
          "tr": "Canvas / matematik deneyi"
        },
        "description": {
      ...
      },
      {
        ...
        "type": {
          "en": "Creative canvas experiment",
          "tr": "Yaratıcı canvas deneyi"
        },
        "description": {
    ...
    "sinamaEvidence": {
      "healthy": {
        ...
        "status": "READY",
        "summary": {
          "en": "Required evidence is collected before the side effect is allowed.",
          "tr": "Side effect'e izin verilmeden önce gerekli kanıtlar toplanıyor."
        },
        "conversation": [
          {
            "speaker": {
            ...
            "text": {
              "en": "My car was damaged. Can you open a claim?",
              "tr": "Aracım hasar gördü. Hasar kaydı açabilir misiniz?"
            }
          },
          {
            "speaker": {
            ...
            "text": {
              "en": "I can help. First I need to verify your contact details and collect the required damage documents.",
              "tr": "Yardımcı olabilirim. Önce iletişim bilgilerinizi doğrulayıp gerekli hasar belgelerini toplamam gerekiyor."
            }
          },
          {
            "speaker": {
            ...
            "text": {
              "en": "Okay, I can send the photos now.",
              "tr": "Tamam, fotoğrafları şimdi gönderebilirim."
            }
          }
        ],
        "toolTrace": [
        ...
        "findings": [
          {
            "level": "PASS",
            "text": {
              "en": "Prerequisite order respected",
              "tr": "Prerequisite sırası korundu"
            }
          },
          {
            "level": "PASS",
            "text": {
              "en": "No forbidden early submission",
              "tr": "Yasak erken submission yok"
            }
          },
          {
            "level": "PASS",
            "text": {
              "en": "Required tool evidence present",
              "tr": "Gerekli tool kanıtı mevcut"
            }
          }
        ]
      },
      "broken": {
        ...
        "status": "BLOCKED",
        "summary": {
          "en": "The agent performs a claim-submission side effect before collecting prerequisites.",
          "tr": "Agent prerequisite'leri toplamadan claim-submission side effect'i gerçekleştiriyor."
        },
        "conversation": [
          {
            "speaker": {
          ...
          },
          {
            ...
            "text": {
              "en": "Sure. I am submitting the claim immediately.",
              "tr": "Tabii. Hasar kaydını hemen oluşturuyorum."
            }
          }
        ],
        "toolTrace": [
        ...
        "findings": [
          {
            "level": "FAIL",
            "text": {
              "en": "Missing prerequisite: verify_contact",
              "tr": "Eksik prerequisite: verify_contact"
            }
          },
          {
            "level": "FAIL",
            "text": {
              "en": "Missing prerequisite: collect_required_documents",
              "tr": "Eksik prerequisite: collect_required_documents"
            }
          },
          {
            "level": "FAIL",
            "text": {
              "en": "Forbidden premature side effect",
              "tr": "Yasak premature side effect"
            }
          }
        ]
      }
