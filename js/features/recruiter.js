...
const recruiterItems = {
  en: {
    ...
    skills: [
      "Translating business workflows into technical scope",
      "Rapid prototyping of usable AI and software solutions",
      "Integrating APIs, data and workflow systems",
      "Evaluating and stabilizing AI behavior",
      "Hands-on delivery with Python/FastAPI, TypeScript and SQL",
    ],
    capabilities: [
      "Customer Discovery",
      "Technical Scoping",
    ...
    proof: [
      "Enterprise customer workflows implemented through conversational-AI work at CBOT: QA, stabilization, channel configuration and large-scale flow restructuring.",
      ...
      "End-to-end delivery of a live customer-facing product and reservation automation at Atölye Joyday using JavaScript, Google Forms, Sheets and Apps Script.",
    ],
    projects: [
      [
  ...
  tr: {
    profile: "Forward Deployed Engineer",
    focus: [
      "Müşteri Discovery ve Scoping",
      "AI Deployment ve Entegrasyon",
      "Evaluation ve Güvenilirlik",
      "Full-Stack Teslim",
    ],
    skills: [
      "İş workflow'larını teknik scope'a çevirme",
      "Kullanılabilir AI ve yazılım çözümlerini hızlı prototipleme",
      "API, veri ve workflow sistemlerini entegre etme",
      "AI davranışını değerlendirme ve stabilize etme",
      "Python/FastAPI, TypeScript ve SQL ile uygulamalı delivery",
    ],
    capabilities: [
      "Customer Discovery",
      "Technical Scoping",
    ...
    proof: [
      "CBOT'taki conversational AI çalışmalarıyla kurumsal müşteri workflow'larının hayata geçirilmesi: QA, stabilizasyon, kanal yapılandırması ve büyük ölçekli akış yeniden yapılandırma.",
      ...
      "JavaScript, Google Forms, Sheets ve Apps Script ile Atölye Joyday canlı müşteri ürününün ve rezervasyon otomasyonunun uçtan uca teslimi.",
    ],
    projects: [
      [
        "SINAMA — AI Agent Reliability Lab",
