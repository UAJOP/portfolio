 ...
 *
 *   browser â†’ HTTPS edge/tunnel â†’ 127.0.0.1:8787/ajoop-rag â†’ Ollama
 *
...
window.KAAN_AJOOP_AI = {
  ...
  /* Warm measured RAG turns are normally ~1â€“4s. Eighteen seconds leaves headroom for rare healthy local inference spikes.n
   * a slow turn while still bounding how long one visible turn can wait before
   * the deterministic answer takes over. */
  timeoutMs: 18000,
